...
export const db = {
  emails: [
    ...
    },
    {
      ...
      subject: 'Magazine say side views.',
      cc: [],
      bcc: [],
      ...
      replies: [
        {
          ...
          cc: [],
          bcc: [],
          message: '<p>Meeting carry shake turn. Money because radio lawyer better. World trial views benefit result someone sort expert. American while public question.</p><p>Court ask various serious safe. Cup than hot child sort.\nSmile views issue high recently develop floor. Ten science including force message. Hear room author return risk military.</p><p>Unit vote popular collection strategy group. Newspaper region fly structure seem story art. Skill ever as money meet involve.\nAs environmental sister investment film represent. Until student occur include few science.</p>',
          attachments: [],
          isStarred: true,
          labels: ['important', 'personal'],
